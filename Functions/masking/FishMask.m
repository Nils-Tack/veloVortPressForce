...
parfor e = 1:c
    ...
    s = min(min(Io));       % Lowest intensity in the image
...
% dilating I'm getting a region that fur sure has the compleate animal
% inside. 

    I1 = edge(Io,'Canny',[0.1 0.3]);
