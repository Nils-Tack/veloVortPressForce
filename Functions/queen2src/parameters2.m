...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    args = struct(...
      'datafolder'           , 'G:\Matlab scripts\computePlotPressureforces\Data\PIVclean', ... % path to PIV clean folder
      'inroot'               , 'B', ... % velocity filename root string
      'outroot'              , 'press', ...
      'blanking'             , 1, ... % enable blanking
      'blankingfolder'       , 'G:\Matlab scripts\computePlotPressureforces\Data\outlines', ... % path to outline folders
      'blankingroot'         , 'iface_', ... % outline filename root string
      'first'                , 1, ... % first file
      'last'                 , 45, ... % to last file
      'increment'            , 1, ...
      'deltaT'               , 0.005, ... % time increment between frame
      'numformat'            , '%05d', ...
      'fileextension'        , '.csv', ... % can also be set to .dat
      'separator'            , ',', ...
      'numheaderlines'       , 0, ...
      'nodecrop'             , 1, ...
      'lengthcalib_axis'     , 1, ... % 1/1000
      'lengthcalib_vel'      , 1, ...
      'timecalib_vel'        , 1, ...
      'nu'                   , 1e-6, ...
      'rho'                  , 1024, ... % for seawater at 30ppt and 21°C = 1020.7
      'gradientplane'        , 'yz', ... 
      'viscous'              , 1, ...
      'smooth_t'             , 1, ...
      'smooth_dp'            , 1, ...
